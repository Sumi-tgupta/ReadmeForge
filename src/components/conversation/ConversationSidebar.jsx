...
import { 
  BarChart2, Clock, CheckCircle2, Circle, 
  MessageSquare, User, Share2, Code2, Rocket, 
  Briefcase, Award, GraduationCap, FileText 
} from 'lucide-react';

const SECTIONS = [
  { key: 'Basic Information', label: 'Basic Info', icon: User },
  { key: 'Social Links', label: 'Socials', icon: Share2 },
  { key: 'About', label: 'About Me', icon: FileText },
  { key: 'Skills', label: 'Tech Stack', icon: Code2 },
  ...
  { key: 'Statistics', label: 'Stats & Activity', icon: BarChart2 },
  { key: 'Customization', label: 'Custom & Support', icon: FileText },
