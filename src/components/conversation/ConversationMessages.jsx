      ...
      <div className="max-w-2xl mx-auto flex flex-col gap-6 w-full">
        {messages.map((msg, index) => {
          ...
          return (
            <ConversationBubble
              key={msg.id || index}
              message={msg}
              username={generator.formData?.username}
              name={generator.formData?.name}
            >
        ...
        {isTyping && (
          <div className="flex gap-4 items-start w-full">
            <div className="w-8 h-8 rounded-xl bg-indigo-650 flex items-center justify-center text-white shrink-0 shadow-sm">
